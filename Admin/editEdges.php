...
if ($nodeId) {
    $stmt = $db->prepare('SELECT edge_id, start_node_id, end_node_id,distance,image,direction,notes FROM Edges WHERE start_node_id = :nodeId');
...
<body>
    <header>
        <h1>Edit Edges for Node: <?php echo $nodeId; ?></h1>
    </header>
